...
@Component({
  ...
  styleUrls: ['./template-syntax.component.less','../../../../assets/guide/user-input/css/user-input-styles.css']
})
export class TemplateSyntaxComponent implements AfterViewInit, OnInit {
  ...
  heroImageUrl = 'assets/guide/template-syntax/images/hero.png';
  // villainImageUrl = 'http://www.clker.com/cliparts/u/s/y/L/x/9/villain-man-hi.png'
  // Public Domain terms of use http://www.clker.com/disclaimer.html
  villainImageUrl = 'assets/guide/template-syntax/images/villain.png';

  iconUrl = 'assets/guide/template-syntax/images/ng-logo.png';
  isActive = false;
  isSpecial = true;
  isUnchanged = true;
